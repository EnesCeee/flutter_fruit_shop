      ...
      children: [
        ...
        if (dotExist)
          Positioned(
            ...
            top: 15,
            child: Container(
                width: 8, height: 8, decoration: const BoxDecoration(color: kPrimaryColor, shape: BoxShape.circle)),
          )
      ],
    ),
  );
...
Widget priceWidget(String price) {
  return RichText(
    ...
    TextSpan(text: "\$$price", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
    const TextSpan(text: " /kg", style: TextStyle(color: Colors.black38, fontWeight: FontWeight.bold)),
  ]));
}
